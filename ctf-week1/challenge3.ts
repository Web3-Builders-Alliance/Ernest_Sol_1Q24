...
// const authPda = PublicKey.findProgramAddressSync([Buffer.from("auth"), keypair.publicKey.toBuffer()], program.programId)[0];
const authPda = PublicKey.findProgramAddressSync([Buffer.from("auth")], program.programId)[0];

console.log(`Your profile is: ${profilePda}`);
console.log(`Your authPda is: ${authPda}`);

// Paste here the mint address for challenge1 token
const mint = new PublicKey("6LrNCNoDVNAXrqrBpbuiuyiQeeF9JxtxKM6Nfsyo7YMo");
...
// https://explorer.solana.com/tx/hnLwH9dic5PD6ei2Rj8hAUD9Egzw1XiijkWC8QSd2SJiE9zMcCcjMwUTtkzpB3Aa9VcyqSjVGiuuVsS9atC34iy?cluster=devnet